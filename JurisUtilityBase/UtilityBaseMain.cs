...
//            listBoxCompanies.SelectedIndexChanged += listBoxCompanies_SelectedIndexChanged;
        ...
        private void DoDaFix()
        {
            ...
            string message = "This will change all Vendor Discount GL Account references from " + fromGLAccount + "\r\n" + "to " + toGLAccount + ". Are you sure?";
            if (fromGLAccount.Equals("****"))
                message = "This will update every Vendor to have Discount GL Account " + toGLAccount + ". Are you sure?";
            ...
            if (result == System.Windows.Forms.DialogResult.Yes)
            {
                ...
                string SQL = "";
                if (fromGLAccount.Equals("****"))
                    SQL = "update vendor set vendiscacct = (select ChtSysNbr from ChartOfAccounts where " + formattingString + " = '" + toGLAccount + "')";
                else
                    SQL = "update Vendor Set vendiscacct = (select ChtSysNbr from ChartOfAccounts where " + formattingString + " = '" + toGLAccount + "') where vendiscacct = (select ChtSysNbr from ChartOfAccounts where " + formattingString + " = '" + fromGLAccount + "')";
